...
export default function Landing() {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section id="hero" className="relative min-h-screen flex items-center hero-bg-new pt-20 sm:pt-24 lg:pt-32 xl:pt-40 pb-16 sm:pb-0 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            <div className="event-date-location mb-2 sm:mb-3 lg:mb-2 flex flex-col sm:flex-row justify-between items-center max-w-4xl mx-auto gap-2 sm:gap-4 hero-date-animate" data-testid="event-date-location">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <Calendar className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-4 lg:h-4 text-white" />
                <p className="text-sm sm:text-base md:text-lg lg:text-base font-bold" style={{ fontFamily: 'Antonio, sans-serif' }}>13-15 DE MAYO, 2026</p>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-4 lg:h-4 text-white" />
                <p className="text-xs sm:text-sm md:text-base lg:text-sm font-bold" style={{ fontFamily: 'Antonio, sans-serif' }}>TIJUANA, BAJA CALIFORNIA</p>
              </div>
            </div>

            <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-5xl font-bold mb-3 sm:mb-6 lg:mb-8 leading-tight px-2 hero-title-animate" style={{ fontFamily: 'Montserrat, sans-serif' }} data-testid="hero-title">
              IX Congreso Internacional<br />de Parques Urbanos
            </h1>

            {/* Countdown Timer */}
            <div className="mb-4 sm:mb-6 lg:mb-8 hero-countdown-animate" data-testid="countdown-timer">
                ...
                {[
                  ...
                  return (
                    <div key={index} className="flex flex-col items-center">
                      <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 mb-1.5 sm:mb-2">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white" style={{ fontFamily: 'Antonio, sans-serif' }}>
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-3xl font-bold mb-4 sm:mb-8 lg:mb-10 text-white leading-relaxed max-w-3xl mx-auto px-2 hero-subtitle-animate" data-testid="hero-subtitle">
              Forma parte de este Evento
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center hero-button-animate px-2">
              <button 
                onClick={() => scrollToSection('convocatorias')} 
                className="hero-cta-button px-6 py-3 sm:px-8 sm:py-4 lg:px-6 lg:py-3 text-base sm:text-lg lg:text-base font-semibold transform hover:scale-105 transition-all text-white rounded-lg border-0"
